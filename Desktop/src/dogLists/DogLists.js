    ...
    <Grid container sx={{ ml: -1.2 }}>
      <Grid container justifyContent="flex-start" sx={{ mt: 9, ml: 30 }}>
        ...
        >
          {doglists.map((dog) => (
            <Grid item sx={{ p: 0, m: 0 }}>
              ...
              >
                <Dog key={dog._id} name={dog.name} ID={dog._id} job={dog.job} />
              </Button>
            </Grid>
          ))}
        </Grid>
        ...
        >
          ...
          >
            {selectedDog && `Dog Name: ${selectedDog?.name}`}
          </Typography>
          <br />
          <Grid item sx={{ ml: 2 }}>
            {selectedDog ? (
          ...
          <Grid item sx={{ ml: 2 }}>
            <Typography variant="h5" sx={{ textAlign: "left", color: "white" }}>
              {!selectedDog ? "No dog selected" : "Tasks:"}
              {selectedDog?.tasks?.length > 0 ? (
                ...
                <Typography
                  ...
                  sx={{ textAlign: "left", ml: 2, color: "white" }}
                >
                  {!selectedDog ? "Select a dog to view tasks" : "No tasks"}
                </Typography>
              )}
            </Typography>
          </Grid>
