...
export function AddAssignmentPage() {
  const { dogs, users, addAssignment } = useApp();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.dogId || !formData.handlerId) {
      toast({
        ...
        description:
          "Please select both a dog and a handler for this assignment.",
        variant: "destructive",
      });
      return;
    }
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleChange("dogId", value)}
                  >
                    <SelectTrigger className="bg-teal-900/50 dark:bg-slate-900/50 border-teal-700 dark:border-slate-700 text-white">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleChange("handlerId", value)}
                  >
                    <SelectTrigger className="bg-teal-900/50 dark:bg-slate-900/50 border-teal-700 dark:border-slate-700 text-white">
